...
<#
    ...
    https://github.com/Griefed/ServerPackCreator/blob/7.2.5/serverpackcreator-api/src/main/resources/de/griefed/resources/server_files/default_template.ps1
...
Write-Host "Start script generated by ServerPackCreator 7.2.5."
